...
const zhCN: Record<string, string> = {
    ...
    'Maximum number of characters stripped from the front of a text run while searching for a fuzzy match. Lower values are faster but may miss a term that is buried more than this many characters after the last punctuation/space. Default 10.': '模糊匹配时，从文本段开头最多截去的字符数。值越小越快，但可能漏掉那些距上一个标点/空格超过该字符数的词条。默认 10。',
